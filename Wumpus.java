    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            if (t[pos].env.contains("G")) {
                complete = 1; System.out.println("Glitter here");
            ...
            if (t[pos].br != 1 && t[pos].r != 1 && t[pos + 1].doubt_pit < 1 && t[pos + 1].doubt_wump < 1 && t[pos + 1].pit != 1 && t[pos + 1].wump != 1 && !(t[pos].back.contains("r") && (t[pos].l != 1 || t[pos].u != 1 || t[pos].d != 1) && check(t[pos]))) {
                ...
                if (condition == 3) {
                    complete = 1;
                    break;
                } else if (condition == 1 && t[pos].visited == 0) { System.out.println("Breeze here");
                    ...
                    t[pos].safe = 1;
                } else if (condition == 2 && t[pos].visited == 0) { System.out.println("Smell here");
                    if (t[pos].br != 1 && t[pos + 1].safe != 1) {
                ...
                t[pos].visited = 1;
            } else if (t[pos].bl != 1 && t[pos].l != 1 && t[pos - 1].doubt_pit < 1 && t[pos - 1].doubt_wump < 1 && t[pos - 1].pit != 1 && t[pos - 1].wump != 1 && !(t[pos].back.contains("l") && (t[pos].r != 1 || t[pos].u != 1 || t[pos].d != 1) && check(t[pos]))) {
                temp1 = "r";
                t[pos].l = 1;
                pos = pos - 1;
                System.out.println("\nback pos= " + pos);
                ...
                t[pos].visited = 1;
            } else if (t[pos].bu != 1 && t[pos].u != 1 && (pos - 4) >= 1 && t[pos - 4].doubt_pit < 1 && t[pos - 4].doubt_wump < 1 && t[pos - 4].pit != 1 && t[pos - 1].wump != 1 && !(t[pos].back.contains("u") && (t[pos].l != 1 || t[pos].r != 1 || t[pos].d != 1) && check(t[pos]))) {
                temp1 = "d";
                t[pos].u = 1;
                pos = pos - 4;
                System.out.println("\nUp pos= " + pos);
                ...
                t[pos].visited = 1;
            } else if (t[pos].bd != 1 && t[pos].d != 1 && (pos + 4) <= 16 && t[pos + 4].doubt_pit < 1 && t[pos + 4].doubt_wump < 1 && t[pos + 4].pit != 1 && t[pos + 4].wump != 1) {
                temp1 = "u";
                t[pos].d = 1;
                pos = pos + 4;
                System.out.println("\ndown pos= " + pos);
